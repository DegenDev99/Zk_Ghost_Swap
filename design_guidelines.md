...
- **Display**: Orbitron or Rajdhana (cyberpunk accent for "ZK SWAP" branding)
...
- Glitch effect on main "ZK SWAP" title (subtle, static)

### Privacy Emphasis
- Minimal branding, no logos beyond ZK SWAP
...
### Swap Page Header
- "ZK SWAP" title with gradient text effect
